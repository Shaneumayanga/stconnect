...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget _buildbutton(String text, Function onpress) {
    return Container(
      ...
      child: RaisedButton(
        elevation: 5.0,
        onPressed: this.is_agreed_to_termsandconditions?onpress: (){
          CoolAlert.show(context: context, type: CoolAlertType.info, title: "Please agree to the Terms and Conditions");
        },
  ...
  Widget _agreementbutton() {
    return Row(
      ...
      children: [
        ...
        Checkbox(value: is_agreed_to_termsandconditions, onChanged:(val){
          setState(() {
